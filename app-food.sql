...
(4, 3, '2024-09-03 12:30:00'),
(7, 3, '2024-09-03 13:00:00'),
(3, 2, '2024-09-03 13:30:00'),
(1, 4, '2024-09-04 14:00:00'),
(2, 5, '2024-09-04 14:30:00'),
(5, 6, '2024-09-04 15:00:00'),
(7, 6, '2024-09-05 15:30:00'),
(2, 5, '2024-09-05 16:00:00'),
(3, 4, '2024-09-05 16:30:00'),
(1, 7, '2024-09-06 17:00:00'),
(5, 8, '2024-09-06 17:30:00'),
(4, 9, '2024-09-06 18:00:00'),
(8, 8, '2024-09-07 18:30:00'),
...
SELECT u.full_name, count(u.user_id) as count_like FROM users as u
...
SELECT r.res_name FROM restaurant as r
...
SELECT u.full_name, COUNT(u.user_id) as count_order FROM users as u
